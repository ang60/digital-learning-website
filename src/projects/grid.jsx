...
const items = [
    {
      ...
      header: <img src ='/img/AGRA.jpeg' className="object-contain w-full h-[110px]" />,
    ...
    },
    {
      ...
      header: <img src = '/img/FIPS.webp' className="object-contain w-full h-[110px]"/>,
      className: "md:col-span-1",
    ...
    },
    {
      ...
      header: <img src ='/img/GIZ.jpeg' className="object-contain w-full h-[110px]" />,
      className: "md:col-span-1",
    ...
    },
    {
      ...
      header: <img src='/img/IJM.jpeg' className="object-contain w-full h-[160px]" />,
  ...
  
    {
      ...
      header: <img src= '/img/kidscancode.webp' className="object-contain w-full h-[100px]" />,
      className: "md:col-span-1",
    ...
    },
    {
      ...
      header: <img src ='/img/mastercard.png' className="object-contain w-full h-[120px]" />,
      className: "md:col-span-1",
      icon: <IconBoxAlignRightFilled className="h-4 w-4 text-neutral-500" />,
    },
    {
      ...
      header: <img src ='/img/UNHCR.png' className="object-contain w-full h-[160px]" />,
      className: "md:col-span-1",
      icon: <IconBoxAlignRightFilled className="h-4 w-4 text-neutral-500" />,
    },
    {
      ...
      header: <img src = '/img/refugees.webp' className="object-contain w-full h-[120px]" />,
      className: "md:col-span-1",
      icon: <IconBoxAlignRightFilled className="h-4 w-4 text-neutral-500" />,
    },
    {
      ...
      header: <img src = '/img/mobilelearning.webp' className="object-contain w-full h-[120px]" />,
      className: "md:col-span-1",
      icon: <IconBoxAlignRightFilled className="h-4 w-4 text-neutral-500" />,
    },
    {
    ...
    "@iLabAfrica Digital Learning, in partnership with Barclays Bank, trains youth in work, people, money, and entrepreneurial skills. The ReadyToWork initiative equips them for employment or self-employment. This helps bridge the gap between education and the workforce."),
      header: <img src = '/img/blended.avif' className="object-contain w-full h-[120px]" />,
      className: "md:col-span-1",
      icon: <IconBoxAlignRightFilled className="h-4 w-4 text-neutral-500" />,
    },
    {
     ...
     "The team trained SOA lecturers on online teaching platforms and screen annotation tools for the Kakuma Refugees project. Twenty-four CPA students in Kakuma received training on online platforms and basic ICT skills. Strathmore University lecturers and @iLabAfrica staff were also trained in online teaching."),
      header: <img src = '/img/blendedlearning.jpg' className="object-contain w-full h-[120px]" />,
      className: "md:col-span-1",
      icon: <IconBoxAlignRightFilled className="h-4 w-4 text-neutral-500" />,
    },
    {
